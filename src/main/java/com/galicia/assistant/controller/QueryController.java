...
public class QueryController {
    ...
    public ResponseEntity<?> receiveQuery(@RequestBody QueryRequest request) {
        ...
        // --- Validación de Entrada (Requisito: Gestión de Errores) ---
        ...
        try {
            ...
            // Usamos 500 para un fallo interno
